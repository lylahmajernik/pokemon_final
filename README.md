This project is a pokedex website for my Rize computer science final. Formatting of readme assisted by ai. All ai use cited in this doccument as well as inline. 
...
AI was used to help assist with propper token and vulnerability debugging. 
Some things that would work locally would not work when deploying, so assisted debugging of my code was a necessary step, used with caution and citations where appropriate
